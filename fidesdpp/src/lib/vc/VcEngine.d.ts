...
export interface VcEngine {
     ...
     */
    verifyDppVc(vcJwt: string, options?: VerifyOptions): Promise<VerificationResult>;
    /**
...
export type { VcEnvelope, IssueOptions, VerifyOptions, VerificationResult, PolkadotAccount, } from './types';
//# sourceMappingURL=VcEngine.d.ts.map
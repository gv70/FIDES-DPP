...
export interface ContractTx<Type extends MetadataType> extends GenericContractTx<Type> {
  ...
  approve: GenericContractTxCall<
    (to: H160, tokenId: bigint, options?: ContractTxOptions) => ContractSubmittableExtrinsic,
    Type
  >;
   ...
   * @selector 0xcfd0c27b
   **/
  setApprovalForAll: GenericContractTxCall<
    (operator: H160, approved: boolean, options?: ContractTxOptions) => ContractSubmittableExtrinsic,
    Type
  >;
  ...
  transferFrom: GenericContractTxCall<
    (from: H160, to: H160, tokenId: bigint, options?: ContractTxOptions) => ContractSubmittableExtrinsic,
    Type
  >;
}

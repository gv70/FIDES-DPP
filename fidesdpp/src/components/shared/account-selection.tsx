              ...
              <div className='flex items-start w-full gap-3 py-1'>
                ...
                <div className='w-full flex flex-col gap-1'>
                  ...
                  <div className='flex justify-between items-center gap-2'>
                    ...
                    {(() => {
	                      const keyType = (one as any).type || (one as any).meta?.type;
	                      if (keyType === 'ed25519') {
	                        return <span className='text-xs text-green-600 dark:text-green-400 font-medium'>ed25519</span>;
	                      } else if (keyType === 'sr25519') {
	                        return <span className='text-xs text-red-600 dark:text-red-400 font-medium'>sr25519</span>;
	                      }
                      return null;
                    })()}
                  </div>
